...
export default function Method() {
  ...
  return (
    <PageShell
      id="method"
      question="이 페이지가 답하는 질문은 하나입니다. 이 숫자들은 어떻게 만들었고 어디까지 믿을 수 있습니까?"
          ...
          {tab === "design" && (
            <Stagger index={0}>
              ...
              <Section title="직업 이름을 맞춘 방법">
                <p className="t-body m-0 max-w-[46rem] text-[0.94rem]">
                  직업 이름은 전직 단계를 하나로 합쳐 최종 전직명으로 맞추었습니다.
                  다크나이트와 크리에이터는 각성 이후 이름이 같은 값으로 돌아오기 때문에 집계에서 한 줄로 합쳐집니다.
                  표에서는 두 직업을 합산한 항목으로 적었고, 직업 화면의 고리에서는 소속 직업군을 붙여 나누어 보였습니다.
                  표본이 10명이 되지 않는 직업은 한 줄로 묶고, 교차표에서 표본이 10명이 되지 않는 칸은 공개하지 않습니다.
                </p>
              </Section>
            ...
            <Stagger index={0}>
              ...
              <Section title="어디까지 말할 수 있습니까">
                <p className="t-body m-0 max-w-[46rem] text-[0.94rem]">
                  ...
                  전체 유저로 넓혀 읽을 수는 없습니다. 다만 직업끼리의 상대 비교와 구간 사이의 기울기처럼
                  같은 조건에서 뽑힌 것끼리의 비교는 편향의 영향을 덜 받습니다.
                </p>
              </Section>
            </Stagger>
          )}
