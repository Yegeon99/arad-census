...
import Sunburst, { GroupLegend } from "../components/charts/Sunburst.jsx";
...
export default function Jobs() {
  ...
  return (
    <PageShell
      id="jobs"
      question="어떤 직업이 표본에 가장 많이 들어왔습니까?"
      ...
      visual={
        <div>
          <div className="grid gap-8 lg:grid-cols-[392px_minmax(0,1fr)] lg:items-center">
          ...
          <div className="mt-6">
            ...
            <GroupLegend tree={jobTree} focus={focus} setFocus={setFocus} hover={hover} setHover={setHover} />
          </div>
        </div>
      }
      ...
      explain={[
        {
          ...
          body: [
            ...
            `표본 ${fmtPeople(meta.sampleSize)} 안에서 이름을 따로 셀 수 있는 직업은 ${namedJobs.length}종입니다. 표본이 10명이 되지 않거나 각성 이후 이름이 다른 직업과 겹쳐 가릴 수 없는 ${etcKinds}종은 ${fmtPeople(etcJobs.count)}으로 한 줄에 합쳤습니다.`,
          ],
        },
        {
          label: "무엇이 나왔는가",
        ...
        },
        {
          ...
          body: [
            "이 순위는 표본 안에서의 순위입니다.",
            "검색 한도 편향이 남아 있으므로 게임 전체 인구의 직업 순위라고 읽을 수 없습니다.",
          ],
        },
      ]}
      details={
