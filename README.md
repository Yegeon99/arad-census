...
상단 내비게이션과 해시 라우팅으로 나눈 7화면 인터랙티브 리포트입니다. 한 화면에
...
| 모델 비용 | $0.0890 (인사이트 배치 3회 누적, 문장 재작성 1회 포함) |
| 수집 소요 | 검색 87초, 활성도 조사 181초 |
| Lighthouse | 데스크톱 성능 98, 모바일 85, 접근성과 권장 사례와 검색 100 ([docs/quality.md](docs/quality.md)) |
