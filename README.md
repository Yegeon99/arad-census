...
| 항목 | 값 |
|---|---|
| 표본 크기 | 전체 31,523명 · 명성값 있음 30,082명 · 완전 검색 5,352명 (명성값 있음 4,087명) |
| 활성도 조사 | 600명 (명성 6구간 층화 비례) |
| API 호출 (누적) | 약 933회 (검증 43 + 직업 트리 1 + 검색 289 + 타임라인 600), 실패 0 |
| LLM 비용 | $0.0890 (인사이트 배치 3회 누적, 문장 재작성 1회 포함) |
| 수집 소요 | 검색 87초 + 활성도 조사 181초 |
| Lighthouse | 데스크톱 성능 98 / 모바일 85, 접근성·권장 사례·검색 100 ([docs/quality.md](docs/quality.md)) |
